...
db = create_engine("postgresql://postgres:storm123@localhost:5432/chinook")
...
jordan_boulton = Programmer(
    first_name = "Jordan",
    last_name = "Boulton",
    gender = "M",
    nationality = "British",
    famous_for = "Dance moves"
)

stefani_dimitrova = Programmer(
    first_name = "Stefani",
    last_name = "Dimitrova",
    gender = "F",
...
# session.add(jordan_boulton)
# session.add(stefani_dimitrova)
# session.add(tim_nelson)


# updating a single record
# programmer = session.query(Programmer).filter_by(id=7).first()
# programmer.famous_for = "Path of Exile Builds"
